  ...
  def singleton(trees: List[CodeTree]): Boolean =
    {
      if (trees.isEmpty)
        ...
        false
    }                                             //> singleton: (trees: List[patmat.worksheet.CodeTree])Boolean
 ...
 def encode(tree: CodeTree)(text: List[Char]): List[Bit] =
  ...
  def quickEncode(tree: CodeTree)(text: List[Char]): List[Bit] =
  {
  	...
  	auxEncode(codeTable,text,List())
                                                  ...
                                                  //| t.worksheet.Bit]
  val toEncode =List('l', 'i', 't', 'e', 'r', 'a', 't', 'u', 'r', 'e',' ' , 'f', 'r', 'o', 'm',' ' , '4', '5',' ' , 'B', 'C',' ',' ', ' ', 'm', 'a', 'k', 'i', 'n', 'g', ' ', 'i', 't', ' ', 'o', 'v', 'e', 'r',' ' , '2', '0', '0', '0', ' ', 'y', 'e', 'a', 'r', 's', ' ', 'o', 'l', 'd', '.')
                                                  //> toEncode  : List[Char] = List(l, i, t, e, r, a, t, u, r, e,  , f, r, o, m,
                                                  //|   , 4, 5,  , B, C,  ,  ,  , m, a, k, i, n, g,  , i, t,  , o, v, e, r,  , 2
                                                  //| , 0, 0, 0,  , y, e, a, r, s,  , o, l, d, .)
  val myCodeTree = createCodeTree(toEncode)       //> myCodeTree  : patmat.worksheet.CodeTree = Fork(Fork(Leaf( ,11),Fork(Fork(L
                                                  //| eaf(i,3),Leaf(t,3),List(i, t),6),Fork(Leaf(a,3),Leaf(o,3),List(a, o),6),Li
                                                  //| st(i, t, a, o),12),List( , i, t, a, o),23),Fork(Fork(Fork(Leaf(0,3),Fork(L
                                                  //| eaf(.,1),Leaf(l,2),List(., l),3),List(0, ., l),6),Fork(Leaf(e,4),Fork(Leaf
                                                  //| (m,2),Fork(Leaf(u,1),Leaf(f,1),List(u, f),2),List(m, u, f),4),List(e, m, u
                                                  //| , f),8),List(0, ., l, e, m, u, f),14),Fork(Fork(Fork(Fork(Leaf(4,1),Leaf(5
                                                  //| ,1),List(4, 5),2),Fork(Leaf(B,1),Leaf(C,1),List(B, C),2),List(4, 5, B, C),
                                                  //| 4),Fork(Fork(Leaf(k,1),Leaf(n,1),List(k, n),2),Fork(Leaf(g,1),Leaf(v,1),Li
                                                  //| st(g, v),2),List(k, n, g, v),4),List(4, 5, B, C, k, n, g, v),8),Fork(Fork(
                                                  //| Fork(Leaf(2,1),Leaf(y,1),List(2, y),2),Fork(Leaf(s,1),Leaf(d,1),List(s, d)
                                                  //| ,2),List(2, y, s, d),4),Leaf(r,5),List(2, y, s, d, r),9),List(4, 5, B, C, 
                                                  //| k, n, g, v, 2, y, s, d, r),17),List(0, ., l, e, m, u, f, 4, 5, B, C, k, n,
                                                  //|  g, v, 2, y, s, d, r),31),List( , i, t, a, o, 0, ., l, e, m, u, f, 4, 5, B
                                                  //| , C, k, n, g, v, 2, y, s, d, r),54)
  decode(myCodeTree, encode(myCodeTree)(toEncode))//> res0: List[Char] = List(l, i, t, e, r, a, t, u, r, e,  , f, r, o, m,  , 4,
                                                  //|  5,  , B, C,  ,  ,  , m, a, k, i, n, g,  , i, t,  , o, v, e, r,  , 2, 0, 0
                                                  //| , 0,  , y, e, a, r, s,  , o, l, d, .)
